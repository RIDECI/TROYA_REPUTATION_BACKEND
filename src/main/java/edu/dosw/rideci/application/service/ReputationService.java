...
public class ReputationService implements CalculateAverageReputationUseCase,DeleteCommentsAdminUseCase, GetAllCommentsUseCase,
    ...
    private PortRatingRepository portReputationRepository;
