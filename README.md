...
Microservicio de perfiles y reputación
...
Gestiona la reputación de cada usuario a partir de las calificaciones recibidas, 
su historial de viajes y reportes, fomentando la confianza en la comunidad.
